...
import PrintIcon from '../../../assests/images/Icon material-report.png';
import PrintIcons from '../../../assests/images/Icon ionic-ios-print.png';
        ...
        <Row>
          <Col lg={12} md={24}>
            <div className="buyer_header_left">
              <Title level={5}>Shipping to buyer - Order no. 827910021</Title>
            </div>
          </Col>
          <Col lg={12} md={24}>
